...
IGMO_AI_GEMINI_MODEL="${IGMO_AI_GEMINI_MODEL:-gemini-3.1-flash-image}"
IGMO_AI_GEMINI_IMAGE_SIZE="${IGMO_AI_GEMINI_IMAGE_SIZE:-1K}"
IGMO_IMAGE_STORAGE_S3_REGION="${IGMO_IMAGE_STORAGE_S3_REGION:-ap-northeast-2}"
IGMO_IMAGE_STORAGE_S3_KEY_PREFIX="${IGMO_IMAGE_STORAGE_S3_KEY_PREFIX:-generated-images}"
